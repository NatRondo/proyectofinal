          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                muestra(context, 'Heridas', 'imagen', 'informacion', 'Ver más', 'ruta'),
                muestra(context, 'Atragantamiento', 'imagen', 'informacion', 'Ver más', 'ruta'),
                muestra(context, 'Fracturas', 'imagen', 'informacion', 'Ver más', 'ruta'),
                muestra(context, 'Hipoglucemia', 'imagen', 'informacion', 'Ver más', 'ruta'),
                muestra(context, 'Incendios', 'imagen', 'informacion', 'Ver más', 'ruta'),
